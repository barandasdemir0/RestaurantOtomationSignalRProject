...
namespace Project.WebUI.Controllers
{
    public class DiscountController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7240/api/Discount/ChangeStatusToTrue/{id}");
        ...
        {
            var client = _httpClientFactory.CreateClient();
           await client.GetAsync($"https://localhost:7240/api/Discount/ChangeStatusToFalse/{id}");
